  ...
  "inline-flex items-center cursor-pointer justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        ...
        outline:
          "border shadow-xs rounded-none border-foreground bg-background/30 text-sm uppercase tracking-[0.15em] text-foreground hover:bg-foreground hover:text-background ",
        secondary:
          "bg-secondary text-secondary-foreground hover:bg-secondary/80",
        ghost:
          "hover:border-accent hover:text-accent-foreground dark:hover:border-accent/50",
        link: "text-primary underline-offset-4 hover:underline",
        landing: "bg-foreground text-sm uppercase tracking-[0.15em] text-background hover:bg-primary/90 shadow-xs"
      },
      size: {
        default: "h-9 px-4 py-2 has-[>svg]:px-3",
        sm: "h-8 rounded-md gap-1.5 px-3 has-[>svg]:px-2.5",
        lg: "h-10 rounded-md px-6 has-[>svg]:px-4",
        xxl: "h-12 md:h-16 rounded-none px-8 md:px-12 as-[>svg]:px-10",
        icon: "size-9",
        "icon-sm": "size-8",
        "icon-lg": "size-10",
      },
