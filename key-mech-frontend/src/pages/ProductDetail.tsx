...
import { ArrowLeft, Heart, Share2, Truck, ShieldCheck } from "lucide-react";
import {
            ...
            <div className="flex flex-col">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-4 pb-8 border-b border-border">
                <Button
                  size="lg"
                  className="flex-1"
                  disabled={product.status !== "IN_STOCK" || addToCart.isPending}
              ...
              <Tabs defaultValue="overview">
                ...
                <TabsContent value="specs" className="mt-4 text-muted-foreground">
                  <div className="space-y-6">
                    {renderSpecBlock("Keyboard Specifications", product.keyboardSpec)}
                    {renderSpecBlock("Switch Specifications", product.switchSpec)}
